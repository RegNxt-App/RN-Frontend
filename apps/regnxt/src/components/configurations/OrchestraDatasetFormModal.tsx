...
export const OrchestraDatasetFormModal: React.FC<DatasetFormModalProps> = ({
  isOpen,
  onClose,
  onSubmit,
  initialData,
  ...
  const checkCodeExists = async (code: string) => {
    ...
    try {
      const response = await orchestraBackendInstance.get(`/api/v1/datasets/`, {
        params: {code},
      });
...
export default OrchestraDatasetFormModal;
